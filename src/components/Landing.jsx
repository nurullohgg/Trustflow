...
import { COLORS, ShieldIcon, CheckCircleIcon, ChartLineIcon, Logo } from './Shared';
...
export function LandingPage({ onNavigate, onReport }) {
  return (
    <div style={{ fontFamily: "'Inter',sans-serif" }}>
      ...
      <section style={{ background:COLORS.bgAlt, padding:'80px 32px' }}>
        <div style={{ maxWidth:1120, margin:'0 auto' }}>
          ...
          <div className="how-grid" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', background:COLORS.white, borderRadius:16, overflow:'hidden', border:`1px solid ${COLORS.border}`, boxShadow:'0 2px 12px rgba(15,118,110,0.07)' }}>
            {[
