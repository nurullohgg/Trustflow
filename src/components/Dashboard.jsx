...
import { COLORS, ShieldIcon, StarIcon, FlagIcon, StatusChip } from './Shared';
...
const ACTIVITY = [
  ...
  { icon:'👀', text:"Profilingiz 12 ta kompaniya tomonidan ko'rildi",                     time:'2 kun oldin' },
...
export function DashboardPage({ onReport }) {
  const [tab, setTab] = React.useState('overview');

  const navItems = [
    { id:'overview',  icon:'⊞', label:"Umumiy ko'rinish [Overview]" },
    ...
    <div style={{ display:'flex', minHeight:'calc(100vh - 62px)', background:COLORS.bg, fontFamily:"'Inter',sans-serif" }} className="side-layout">
      ...
      <main style={{ flex:1, padding:'32px 36px', overflowY:'auto' }}>
        <div style={{ maxWidth:920 }}>
          ...
          <div className="dash-main-grid" style={{ display:'grid', gridTemplateColumns:'1fr 310px', gap:22 }}>
