...
import { COLORS, MapPinIcon, ClockIcon, UsersIcon, SearchIcon, FlagIcon, VerifiedBadge, RiskBadge } from './Shared';
...
function JobCard({ job, onReport }) {
  ...
  return (
    ...
    onMouseLeave={e=>{e.currentTarget.style.borderColor=COLORS.border;e.currentTarget.style.boxShadow='0 1px 6px rgba(15,118,110,0.05)';}}>
      ...
      <div className="job-card-head" style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:14 }}>
        <div>
...
export function JobListingsPage({ onReport }) {
