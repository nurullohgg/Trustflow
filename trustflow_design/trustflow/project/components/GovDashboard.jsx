// GovDashboard.jsx — Government monitoring dashboard + Uzbekistan choropleth map
...
// ── Uzbekistan simplified choropleth ──────────────────────────────────────
...
function GovDashboardPage() {
  ...
  return (
    <div style={{ display:'flex', minHeight:'calc(100vh - 62px)', background:COLORS.darkSurface, fontFamily:"'Inter',sans-serif" }}>
...
Object.assign(window, { GovDashboardPage, UzbekistanMap });
